...
public class Main
{
	public static void main(String[] args) {
       ...
       System.out.println("Chance          "+chance(5,2,2,2,5));
	}
...
public static void threes(int dice1, int dice2, int dice3, int dice4, int dice5)
     {
         int a=0;
...
public static void fours(int dice1, int dice2, int dice3, int dice4, int dice5)
     {
         int a=0;
...
public static int fives(int a, int b, int c, int d, int e){
 ...
 public static int sixes(int a, int b, int c, int d, int e){
      ...
      public static void threeofakind(int a, int b, int c, int d, int e){
         if ((a == b) && (a == c)){
